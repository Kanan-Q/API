...
namespace WebApplication1.Configurations
{
    public class LanguageConfiguration : IEntityTypeConfiguration<Language>
    {
        ...
        {
            builder.HasKey(y => y.Code);
            builder.HasIndex(y => y.Name).IsUnique();
            builder.Property(y => y.Code).IsFixedLength(true).HasMaxLength(2);
            builder.Property(y => y.Name).IsRequired().HasMaxLength(32);
            builder.Property(x => x.Icon).HasMaxLength(3000);
